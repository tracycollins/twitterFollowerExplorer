...
const fetchAllReady = function(){
  ...
  return (loadedNetworksFlag && processUserQueueReady && processUserQueueEmpty() );
};
...
const fsmStates = {
  ...
  "FETCH_ALL":{
    ...
    fsm_tick: function() {
      ...
      childCheckState("FETCH_END").then(function(allChildrenFetchEnd){
