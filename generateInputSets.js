...
const DEFAULT_MAX_INPUTS_GENERATED = 1750;
const DEFAULT_MAX_NUM_INPUTS_PER_TYPE = 375;
const DEFAULT_MIN_NUM_INPUTS_PER_TYPE = 275;
const DEFAULT_TOTAL_MIN_STEP = 0.9;
